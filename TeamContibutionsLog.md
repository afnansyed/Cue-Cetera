...
| 8/31 | Amani | Back-end and front-end linking research and exploration | 5 hrs
| 9/1 | Diana |  Finished cleaning/reshaping emotic dataset  | 2.5 hrs
| 9/1 | Amani | Flask server setup attempt for REST integration | 3 hrs
| 9/4 | Amani | Research Firebase Functions for front-end to back-end link | 3 hrs
...
| 9/5 | Amani | Firebase functions integration | 4 hrs
...
| 9/6 | Amani | Firebase functions integration testing | 3 hrs
...
| 9/7 | Amani | Firebase functions debug and fixing | 5 hrs
...
| 10/25 | Diana | Combined 'disgust' samples with angry, and deleted contempt due to it having only a small number of samples, converted the images to grayscale for training, re-ran model 15 on new samples, tested/compared using regularizers, increased the accuracy of the model to 91% in validation/testing + created small beta testing dataset to test the performance of the model | 3.5 hrs
