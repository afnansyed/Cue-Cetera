...
| 11/2 | Diana | Got access to CK+ full dataset, preprocessed images with avaliable labels, tested it with combined dataset, worked on prelimanary report, continued to re-run models/measure performance | 3 hrs
